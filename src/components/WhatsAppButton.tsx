...
export default function WhatsAppButton() {
    ...
    return (
        ...
        >
            ...
            {/* Glowing Ring Effect */}
            <div className="absolute inset-0 bg-[#25d366] rounded-full blur-md opacity-40 group-hover:opacity-60 animate-pulse transition-all"></div>

            {/* Main Button */}
            <div className="relative bg-gradient-to-br from-[#25d366] to-[#128c7e] text-white p-4 rounded-full shadow-2xl transform transition-all group-hover:scale-110 group-active:scale-95 flex items-center justify-center">
                <svg
                    className="w-8 h-8"
                    fill="currentColor"
                    viewBox="0 0 24 24"
